...
# Exp dirs
cfg.EXP_NAME = "SYNTHIA2Cityscapes_DeepLabv2_Depdis"
...
cfg.TRAIN.INFO_TARGET = str(project_root / "main/dataset/cityscapes_list/info16class.json")
...
cfg.TRAIN.LAMBDA_DEP_SRC = 0.005 # weight of source depth loss
cfg.TRAIN.LAMBDA_ADV_TAR = 0.05  # weight of target adv loss
...
cfg.TEST.INFO_TARGET = str(project_root / "main/dataset/cityscapes_list/info16class.json")

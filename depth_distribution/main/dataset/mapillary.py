...
class MapillaryDataSet_1(BaseDataset):
    def __init__(self, root, list_path, set='train',
                 max_iters=None,
                 crop_size=(321, 321),
                 mean=(128, 128, 128),
    ...
    def get_metadata(self, name):
        img_file = self.root / self.set.replace('self', '') / 'images' / name
        label_name = name.replace(".jpg", ".png")
        label_file = self.root / self.set.replace('self', '') / 'labels' / label_name
        return img_file, label_file
...
class MapillaryDataSet_2(BaseDataset):
    def __init__(self, root, list_path, set='train',
                 max_iters=None,
                 crop_size=(321, 321),
                 mean=(128, 128, 128),
